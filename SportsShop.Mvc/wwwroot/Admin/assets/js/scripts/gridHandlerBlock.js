...
const insertData = (data) => {
  ...
  data.map((item) => {
    cards += `
    <div id="Block_${item.BlockId}" class="col-lg-2">
             
                <div class="card grid-shadow">
                    <div class="card-body p-0">                                        
                        
                        <div class="text-center project-card">
                            <img src="/block/${item.FileName}" loading="lazy" alt="${item.FileName}"  class="mx-auto d-block mb-3 w-100"> 
                           <div class="row">
                             <div class="col-md-8">
                              ...
                              <div class=" d-flex justify-content-end">                                        
                                <div class="dropdown d-inline-block" style="margin: 10px 0;">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dLabel1">
                                        <a class="dropdown-item" href="/Floor/Index/${item.BlockId}?projectId=${item.ProjectId}">طبقه  </a> 
                                        <a class="dropdown-item" href="/Block/BlockCopy/${item.BlockId}?projectId=${item.ProjectId}">کپی  </a>
                                        <a class="dropdown-item" href="/Block/BlockEdit/${item.BlockId}">ویرایش  </a> 
                                        <a class="dropdown-item"  onclick="DeleteBlock(${item.BlockId})">حذف </a> 
