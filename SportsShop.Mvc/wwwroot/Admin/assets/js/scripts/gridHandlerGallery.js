...
const insertData = (data) => {
  ...
  data.map((item) => {
    cards += `
    <div id="Gallery_${item.GalleryId}" class="col-lg-2">
                              ...
                              <div class=" d-flex justify-content-end">                                        
                                <div class="dropdown d-inline-block" style="margin: 10px 0;">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dLabel1">
                                        <a class="dropdown-item" href="/Gallery/GalleryEdit/${item.GalleryId}">ویرایش  </a> 
                                        <a class="dropdown-item"  onclick="DeleteGallery(${item.GalleryId})">حذف </a> 
