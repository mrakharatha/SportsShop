const legalForm = ` <form  method="post"    class="form-parsley" enctype="multipart/form-data" action="/Contractor/ContractorLegalCreate" >
                        <div class="form-group row">
                            <label class=" col-form-label" for="Name">نام شرکت پیمانکار</label>
                            <input  autocomplete="off" class="form-control" type="text" Maxlength="200" data-parsley-max-message="نام شرکت پیمانکار نمی تواند بیشتر از 200 کاراکتر باشد ."  data-parsley-required-message="لطفا نام شرکت پیمانکار را وارد کنید " id="Name" required name="Name" value="">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="announcementCompanyChangesFile" name="announcementCompanyChangesFile" lang="fa">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="companyValueAddedCertificateFile" name="companyValueAddedCertificateFile" lang="fa">
                                <label class="custom-file-label">انتخاب تصویر</label>
                            </div>
                        </div>

                        <div class="form-group row">
                            <label class=" col-form-label" for="PictureContractor">تصویر پیمانکار</label>
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="pictureContractorFile" name="pictureContractorFile" lang="fa">
                                <label class="custom-file-label">انتخاب تصویر</label>
                            </div>
                        </div>
...
const realForm = ` <form  method="post"    class="form-parsley" enctype="multipart/form-data" action="/Contractor/ContractorRealCreate" >
                    <div class="form-group row">
                        <label class=" col-form-label" for="Name">نام  پیمانکار</label>
                        <input  autocomplete="off" class="form-control" type="text"  data-parsley-max-message="نام شرکت پیمانکار نمی تواند بیشتر از 200 کاراکتر باشد ."  required  data-parsley-required-message="لطفا نام شرکت پیمانکار را وارد کنید " id="Name" maxlength="200" name="Name" value="">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="NationalCardImageFile" name="nationalCardImageFile" lang="fa">
                            <label class="custom-file-label">انتخاب تصویر</label>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="custom-file">
                            <input type="file" class="custom-file-input" id="IdCardImageFile" name="idCardImageFile" lang="fa">
                            <label class="custom-file-label">انتخاب تصویر</label>
                        </div>
                    </div>
