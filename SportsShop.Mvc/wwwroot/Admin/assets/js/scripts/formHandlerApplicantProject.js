const legalForm = ` <form  method="post"    class="form-parsley" enctype="multipart/form-data" action="/ProjectApplicant/ApplicantLegalCreate" >
...
const realForm = ` <form  method="post"    class="form-parsley" enctype="multipart/form-data" action="/ProjectApplicant/ApplicantRealCreate" >
                    <div class="form-group row">
                        <label class=" col-form-label" for="Name">نام  متقاضی</label>
                        <input  autocomplete="off" class="form-control" type="text"  data-parsley-max-message="نام شرکت متقاضی نمی تواند بیشتر از 200 کاراکتر باشد ."  required  data-parsley-required-message="لطفا نام شرکت متقاضی را وارد کنید " id="Name" maxlength="200" name="Name" value="">
