const legalForm = ` <form  method="post"    class="form-parsley" enctype="multipart/form-data" action="/Employer/EmployerLegalCreate" >
                        <div class="form-group row">
                            <label class=" col-form-label" for="Name">نام شرکت کارفرما</label>
                            <input  autocomplete="off" class="form-control" type="text" Maxlength="200" data-parsley-max-message="نام شرکت کارفرما نمی تواند بیشتر از 200 کاراکتر باشد ."  data-parsley-required-message="لطفا نام شرکت کارفرما را وارد کنید " id="Name" required name="Name" value="">
                        ...
                        <div class="form-group row">
                            <label class=" col-form-label" for="pictureEmployerFile">تصویر کارفرما</label>
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" id="pictureEmployerFile" name="pictureEmployerFile" lang="fa">
...
const realForm = ` <form  method="post"    class="form-parsley" enctype="multipart/form-data" action="/Employer/EmployerRealCreate" >
                    <div class="form-group row">
                        <label class=" col-form-label" for="Name">نام  کارفرما</label>
                        <input  autocomplete="off" class="form-control" type="text"  data-parsley-max-message="نام شرکت کارفرما نمی تواند بیشتر از 200 کاراکتر باشد ."  required  data-parsley-required-message="لطفا نام شرکت کارفرما را وارد کنید " id="Name" maxlength="200" name="Name" value="">
