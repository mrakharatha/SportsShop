...
const insertData = (data) => {
  ...
  data.map((item) => {
    cards += `
    <div id="Floor_${item.FloorId}" class="col-lg-2">
             
                <div class="card grid-shadow">
                    <div class="card-body p-0">                                        
                        
                        <div class="text-center project-card">
                            <img src="/floor/${item.FileName}" loading="lazy" alt="${item.FileName}"  class="mx-auto d-block mb-3 w-100"> 
                           <div class="row">
                             <div class="col-md-8">
                              ...
                              <div class=" d-flex justify-content-end">                                        
                                <div class="dropdown d-inline-block" style="margin: 10px 0;">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dLabel1">
                                        <a class="dropdown-item" href="/Unit/Index/${item.FloorId}?blockId=${item.BlockId}&projectId=${item.ProjectId}">واحد  </a> 
                                        <a class="dropdown-item" href="/Floor/FloorCopy/${item.FloorId}?blockId=${item.BlockId}&projectId=${item.ProjectId}">کپی  </a>
                                        <a class="dropdown-item" href="/Floor/FloorEdit/${item.FloorId}">ویرایش  </a> 
                                        <a class="dropdown-item"  onclick="DeleteFloor(${item.FloorId})">حذف </a> 
